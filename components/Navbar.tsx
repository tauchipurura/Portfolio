      ...
      <div className='w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4'>
          <div className='max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between'>
              ...
              <div className='hidden mdl:inline-flex items-center gap-7'>
                  ...
                  <a href="/assets/tau_resume.pdf" target='_blank'>
                    <motion.button
                        initial={{y:-10, opacity:0}}
                        animate={{y: 0, opacity:1}}
                              ...
                              <div className='flex flex-col items-center gap-7'>
                                  ...
                                  <div className='flex gap-4'>
                                      <motion.a
                                          ...
                                          href="https://github.com/tauchipurura" target="_blank">
                                      ...
                                      <motion.a
                                          ...
                                          animate={{ y: 0, opacity: 1 }}
                                          transition={{delay:1 , ease:"easeIn"}}
                                          href="https://www.instagram.com/tau.inc/" target="_blank">
                                      ...
                                      <motion.a
                                          ...
                                          animate={{ y: 0, opacity: 1 }}
                                          transition={{delay:1 , ease:"easeIn"}}
                                          href="https://www.linkedin.com/in/tau-chipurura-66892282/" target="_blank"
                                      >
                                        <span className="w-10 h-10 text-xl bg-hoverColor rounded-full inline-flex items-center justify-center hover:text-textGreen cursor-pointer hover:-translate-y-2 transition-all duration-300">
                                            <SlSocialLinkedin/>
                                        </span>
                                  ...
                                  <motion.a
                                      ...
                                      href='mailto:tauraichipurura@gmail.com'
                                  >
                                      <p>txchipurura.inc</p>
                                  </motion.a>
                               </div>
